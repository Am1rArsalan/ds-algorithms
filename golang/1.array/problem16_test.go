...
func TestMergeWithoutExtraSpace2(t *testing.T) {
	r1, r2 := MergeWithoutExtraSpace2([]int{1, 3, 5, 7}, []int{0, 2, 6, 8, 9})
	er1 := []int{0, 1, 2, 3}
	er2 := []int{5, 6, 7, 8, 9}
	...
	r1, r2 = MergeWithoutExtraSpace2([]int{10, 12}, []int{5, 18, 20})
	er1 = []int{5, 10}
	er2 = []int{12, 18, 20}
	...
	r1, r2 = MergeWithoutExtraSpace2([]int{1, 35}, []int{6, 9, 13, 15, 20, 25, 29, 46})
	er1 = []int{1, 6}
	er2 = []int{9, 13, 15, 20, 25, 29, 35, 46}
